...
<!-- can add new category this way, the type must be exactly same as category in database table -->
    <ul><a href="index.php">All</a> </ul>
    <ul><a href="index.php?type=audio accessory">Audio Accessory</a> </ul>
    <ul><a href="index.php?type=gaming device">Gaming Devices</a></ul>
    <ul><a href="index.php?type=GPU">GPU</a></ul>
    <ul><a href="index.php?type=Laptop">Laptops</a></ul>
    <ul>Brands:</ul>
