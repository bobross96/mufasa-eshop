...
<div style="border-style: none; padding:20px; text-align: center">
    ...
    <span><label for="search"></label><input name="search" type="text" placeholder="Search for your products here" style="width:30%;padding: 16px 16px;margin-left: 5%;vertical-align: middle"></span>
	<button type="submit" style="padding: 16px 16px; margin-right: 10%; vertical-align: middle"><i class="fa fa-search"></i></button>
    <a href="cart.php"><span style="padding: 16px 16px;min-width:40%;margin-right: 2%" ><img src="images/cart.svg" alt="carty" width="50px" height="50px" style="vertical-align: middle; text-align: right"></span></a>
